...
let data = [
    {
        'id': 'a1',
        'title': '_Beautiful recitation of quran',
        'name': '_Beautiful recitation of quran.mp4',
        'duration': '2:47',
    },
    {
        'id': 'a2',
...
data.forEach((video, i) => {
    let video_element = `
                <div class="video" data-id="${video.id}">
                    <img src="file:///C:/Users/HP/Downloads/play.svg" alt="">
                    <p>${i + 1 > 9 ? i + 1 : '0' + (i + 1)}. </p>
...
videos[0].querySelector('img').src = 'file:///C:/Users/HP/Downloads/pause.svg';
...
videos.forEach(selected_video => {
    selected_video.onclick = () => {
        ...
        for (all_videos of videos) {
            ...
            all_videos.querySelector('img').src = 'file:///C:/Users/HP/Downloads/play.svg';

        }

        selected_video.classList.add('active');
        selected_video.querySelector('img').src = 'file:///C:/Users/HP/Downloads/pause.svg';

        let match_video = data.find(video => video.id == selected_video.dataset.id);
        main_video.src = 'C:/Users/HP/videos/' + match_video.name;
...
if (localStorage.getItem('loggedIn') === 'true') {
    ...
    // Hide the video and display a message
    document.querySelector('.main-video').style.display = 'none';
    document.querySelector('.video-playlist').innerHTML = 'Please log in to watch this video';
  }
...
if (localStorage.getItem('loggedIn') === 'true') {
    // Show the video
    document.querySelector('.main-video').style.display = 'block';
    document.querySelector('.video-playlist').style.display = 'block';
